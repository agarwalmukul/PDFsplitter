...
TESTS_ROOT = os.path.abspath(os.path.dirname("/Users/Mukul/Desktop/mukul/PyPDF2-master/Tests"))
...
class PdfReaderTestCases(unittest.TestCase):
    ...
    def test_PdfReaderFileLoad(self):
        ...
        #with open('/Users/Mukul/Desktop/mukul/PyPDF2-master/Resources/crazyones.pdf', 'rb') as inputfile:
